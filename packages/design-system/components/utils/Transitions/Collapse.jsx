...
import { getAutoHeightDuration, getTransitionProps } from '@utils';
    ...
    >
      {(state, childProps) => (
        <CollapseRoot
          ...
          {...childProps}
        >
          <CollapseWrapper ownerState={{ ...ownerState, state }} className={'Collapse-Wrapper'} ref={wrapperRef}>
            <CollapseWrapperInner ownerState={{ ...ownerState, state }} className={'Collapse-WrapperInner'}>
              {children}
