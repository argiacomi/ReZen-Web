...
const setTransitionStyle = (node, style, timeout, easing, mode, theme, onTransition, isAppearing) => {
  reflow(node);
...
const Grow = React.forwardRef((props, ref) => {
  ...
  const handleEnter = normalizedTransitionCallback((node, isAppearing) => {
    autoTimeout.current = setTransitionStyle(node, style, timeout, easing, 'enter', theme, onEnter, isAppearing);
