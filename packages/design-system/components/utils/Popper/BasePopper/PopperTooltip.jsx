...
const PopperTooltip = React.forwardRef((props, ref) => {
  ...
  const { id: arrowId = 'arrow', width: arrowInputWidth = 8, padding: arrowPadding = 8 } = arrow || {};
  ...
  useEnhancedEffect(() => {
    ...
    const arrowElement = arrowId ? document.getElementById(arrowId) : document.getElementById('arrow');
  ...
  const TransitionComponent =
    typeof transition === 'string' ? Transitions[transition] || Transitions['Fade'] : Transitions['Fade'];
