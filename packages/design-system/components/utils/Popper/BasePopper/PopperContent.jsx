...
const PopperContentRoot = styled(Paper)(({ theme, ownerState }) => ({
  ...
  ['--popper-arrow-border-color']: ownerState.outlined ? `${theme.colors.divider}` : 'transparent',
...
const PopperContent = React.forwardRef((props, ref) => {
  ...
  return (
    <PopperContentComponent {...popperContentProps}>
      {!disableArrow && (
        <PopperArrow disableArrow={disableArrow} elevation={elevation} outlined={outlined} {...slotProps.arrow} />
      )}
      {children}
