...
import { useControlled, useEventCallback, useForkRef, useId, useIsFocusVisible } from '@hooks';
import { appendOwnerState, createChainedFunction } from '@utils';
...
const TooltipTooltip = styled(PopperContent)(({ theme }) => {
  const backgroundColor = theme.colors.default[600];
...
const Tooltip = React.forwardRef((props, ref) => {
  ...
  if (!disableHoverListener) {
    ...
    childrenProps.onMouseLeave = createChainedFunction([handleMouseLeave, childrenProps.onMouseLeave]);
  ...
  const tooltipProps = appendOwnerState(
    ...
    {
      ...slotProps.tooltip,
      className: clsx(classes.tooltip, slotProps.tooltip?.className, className),
      ...(ownerState.touch && {
        padding: '8px 16px',
