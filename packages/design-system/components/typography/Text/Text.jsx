...
export const TextRoot = styled('span')(({ theme, ownerState }) => {
  ...
  let color =
    colorStyles[ownerState.color] || (theme.colors[ownerState.color] ? theme.colors[ownerState.color][500] : undefined);
...
const Text = React.forwardRef((props, ref) => {
  ...
  const component =
    componentProp || (paragraph ? 'p' : variantMapping[variant] || defaultVariantMapping[variant]) || 'span';
