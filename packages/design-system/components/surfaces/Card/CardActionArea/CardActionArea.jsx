...
const CardActionArea = React.forwardRef((props, ref) => {
  const { children, component, focusVisibleClassName, slots = {}, slotProps = {}, ...otherProps } = props;
  ...
  return (
    <CardActionAreaComponent {...cardActionAreaRootProps}>
      {children}
      <CardActionAreaFocusHighlight className={cardActionAreaClasses.focusHighlight} ownerState={ownerState} />
