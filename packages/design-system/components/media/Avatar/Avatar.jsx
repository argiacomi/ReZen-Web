...
import { useLoaded, useSlotProps } from '@hooks';
...
const AvatarRoot = styled('div', {
  ...
  ...(ownerState.colorDefault && {
    ...
    backgroundColor: theme.colors.default.body
  }),
...
const Avatar = React.forwardRef((props, ref) => {
  ...
  if (hasImgNotFailing) {
    ...
    children = <AvatarFallback icon='MdPerson' ownerState={ownerState} className={classes.fallback} />;
  }
