...
const OutlinedInputRoot = styled(InputBaseRoot, {
  ...
  return {
    ...
    [`${theme.getColorSchemeSelector()} and (hover: none)`]: {
      [`&:hover .${outlinedInputClasses.notchedOutline}`]: {
        borderColor: 'rgba(255, 255, 255, 0.23)'
      }
    },
    [`&.${outlinedInputClasses.focused} .${outlinedInputClasses.notchedOutline}`]: {
      borderColor: theme.colors[ownerState.color].body,
      borderWidth: 2
    },
    [`&.${outlinedInputClasses.error} .${outlinedInputClasses.notchedOutline}`]: {
      borderColor: theme.colors.danger.body
    },
    ...
    <InputBase
      ...
      renderSuffix={(state) => (
        <NotchedOutlineRoot
          ...
          notched={
            typeof notched !== 'undefined' ? notched : Boolean(state.startAdornment || state.filled || state.focused)
          }
        />
      )}
      fullWidth={fullWidth}
