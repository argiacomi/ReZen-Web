...
const FormGroup = React.forwardRef((props, ref) => {
  const { component: componentProp = 'div', row = false, slots = {}, slotProps = {}, ...otherProps } = props;
  ...
  const classes = {
    root: [formGroupClasses.root, ownerState.row && formGroupClasses.row, ownerState.error && formGroupClasses.error]
  };
