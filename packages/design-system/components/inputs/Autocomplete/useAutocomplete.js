...
import { setRef, useControlled, useEventCallback, useId, usePreviousProps } from '@hooks';
    ...
    ? filterOptions(
        options.filter((option) => {
          if (
            ...
            (multiple ? value : [value]).some((value2) => value2 !== null && isOptionEqualToValue(option, value2))
          ) {
            return false;
          }
          return true;
