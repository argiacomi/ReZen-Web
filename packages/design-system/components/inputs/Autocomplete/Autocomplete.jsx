...
import { filledInputClasses, inputBaseClasses, inputClasses, outlinedInputClasses } from '..';
    ...
    '&[aria-selected="true"]': {
      ...
      [`&.${autocompleteClasses.focused}`]: {
        backgroundColor: theme.colors.alpha.add(
          ...
          `calc(theme.colors.selectedOpacity + theme.colors.hoverOpacity)`
        ),
        '@media (hover: none)': {
      ...
      [`&.${autocompleteClasses.focusVisible}`]: {
        backgroundColor: theme.colors.alpha.add(
          theme.colors.primary.body,
          `calc(theme.colors.selectedOpacity + theme.colors.focusOpacity)`
        )
      }
    }
  }
...
const Autocomplete = React.forwardRef((props, ref) => {
  ...
  const classes = {
    ...
    popper: [autocompleteClasses.popper, ownerState.disablePortal && autocompleteClasses.popperDisablePortal],
