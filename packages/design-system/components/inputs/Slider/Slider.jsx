...
import { capitalize, isHostComponent, shouldSpreadAdditionalProps } from '@utils';
...
export const SliderRail = styled('span', {
  ...
  ...(ownerState.track === 'inverted' && {
    backgroundColor: ownerState.disabled ? theme.colors.disabled.body : 'currentColor'
  })
}));
...
export const SliderTrack = styled('span', {
  ...
  ...(ownerState.track === 'inverted' && {
    backgroundColor: theme.colors.alpha.lighten(theme.colors[ownerState.color].body, 0.62),
    [`${theme.getColorSchemeSelector()}`]: {
      backgroundColor: theme.colors.alpha.darken(theme.colors[ownerState.color].body, 0.5)
    }
  })
}));
...
export const SliderThumb = styled('span', {
  ...
  [`&:hover, &.${sliderClasses.focusVisible}`]: {
    boxShadow: `0px 0px 0px 8px ${theme.colors.alpha.add(theme.colors[ownerState.color].body, 0.16)}`,
    '@media (hover: none)': {
      boxShadow: 'none'
    }
  },
  [`&.${sliderClasses.active}`]: {
    boxShadow: `0px 0px 0px 14px ${theme.colors.alpha.add(theme.colors[ownerState.color].body, 0.16)}`
  },
  [`&.${sliderClasses.disabled}`]: {
    '&:hover': {
      boxShadow: 'none'
...
const SliderValueLabel = styled(BaseValueLabel, {
  ...
  ...(ownerState.disabled && {
    ...
    color: theme.colors.disabled.typography
  }),
  boxShadow: theme.boxShadow[2],
...
export const SliderMarkLabel = styled('span', {
  ...
  ...theme.typography.size.sm,
  ...(ownerState.size === 'small' && theme.typography.size.xs),
  fontWeight: theme.typography.weight.medium,
            ...
            {valueLabelDisplay !== 'off' ? (
              <ValueLabelSlot
                ...
                className={clsx(
                  ...
                  (open === index || active === index || valueLabelDisplay === 'on') && classes.valueLabelOpen
                )}
                open={open === index}
